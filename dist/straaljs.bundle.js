...
;(function (root, factory, undef) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__webpack_require__(0), __webpack_require__(9), __webpack_require__(10), __webpack_require__(3), __webpack_require__(2));
	}
	else {}
}(this, function (CryptoJS) {
...
// CONCATENATED MODULE: ./src/utils/isObjectLike.js
function isObjectLike( data ) {
    return typeof data === 'object' && data !== null;
}

// CONCATENATED MODULE: ./src/utils/isString.js
function isString( data ) {
    return typeof data === 'string' || data instanceof String;
}

// CONCATENATED MODULE: ./src/utils/isArray.js
function isArray( data ) {
    return Array.isArray( data );
}

// CONCATENATED MODULE: ./src/utils/isNumber.js
function isNumber ( data ) {
    return typeof data === 'number';
}

// CONCATENATED MODULE: ./src/utils/objectHas.js
function objectHas( object, key ) {
    return object != null && hasOwnProperty.call(object, key)
}

// CONCATENATED MODULE: ./src/utils/toString.js




function toString_toString( data ) {
    if( data == null ) return '';
    if( isString( data )) return data;
    if( isArray( data )) return data.map( toString_toString ).join(',');

    var result = '' + data;
    return (result == '0' && (1 / data) == -( 1/0 )) ? '-0' : result;
}

// CONCATENATED MODULE: ./src/utils/isFunction.js
...
// CONCATENATED MODULE: ./src/errors/errorsFactory.js
...
function createErrorMessage(options) {
    var msg = toString_toString(options.code) + ' ' + toString_toString(options.message);
    return msg.trim();
}

// CONCATENATED MODULE: ./src/errors/crypto.js
...
// CONCATENATED MODULE: ./src/errors/errors.js
...
// CONCATENATED MODULE: ./src/errors/requests.js
...
var aes = __webpack_require__(4);
var aes_default = /*#__PURE__*/__webpack_require__.n(aes);

// EXTERNAL MODULE: ./node_modules/crypto-js/mode-cfb.js
var mode_cfb = __webpack_require__(5);
var mode_cfb_default = /*#__PURE__*/__webpack_require__.n(mode_cfb);

// EXTERNAL MODULE: ./node_modules/crypto-js/pad-zeropadding.js
var pad_zeropadding = __webpack_require__(6);
var pad_zeropadding_default = /*#__PURE__*/__webpack_require__.n(pad_zeropadding);

// EXTERNAL MODULE: ./node_modules/crypto-js/enc-utf8.js
var enc_utf8 = __webpack_require__(7);
var enc_utf8_default = /*#__PURE__*/__webpack_require__.n(enc_utf8);

// EXTERNAL MODULE: ./node_modules/crypto-js/enc-hex.js
var enc_hex = __webpack_require__(1);
var enc_hex_default = /*#__PURE__*/__webpack_require__.n(enc_hex);

// CONCATENATED MODULE: ./src/core/validators.js
...
function lengthValidator( length ) {
    return function( data ) {
        var strVal = toString_toString( data );
...
function parseCryptKey(cryptKey) {
    cryptKey = toString_toString(cryptKey);
...
function encrypt(message, keyHex, ivHex) {
    ...
    message = enc_utf8_default.a.parse(message);

    var options = {
        iv: keyAndIv.iv,
        mode: mode_cfb_default.a,
        padding: pad_zeropadding_default.a
    };

    var encrypted = aes_default.a.encrypt(message, keyAndIv.key, options);
    return enc_hex_default.a.stringify(encrypted.ciphertext);
}
...
function parseKeyAndIv(keyHex, ivHex) {
    ...
    return {
        key: enc_hex_default.a.parse(keyHex),
        iv: enc_hex_default.a.parse(ivHex)
    };
}

// CONCATENATED MODULE: ./src/core/requests.js
...
function postEncoded(url, jsonData, cryptKey, options) {
    ...
    return requests_post(url, encryptedData, {
...
function requests_post(url, data, options) {
...
// CONCATENATED MODULE: ./src/core/straalUrl.js
...
// CONCATENATED MODULE: ./src/api/core.js
...
/* harmony default export */ var src = __webpack_exports__["default"] = (Straal);
